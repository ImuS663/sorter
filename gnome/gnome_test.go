...
func TestGnome_Sort_Uint32(t *testing.T) {
	...
	result := Gnome[uint32]{}.Sort(unsortedArr)
...
func TestGnome_Sort_Float64(t *testing.T) {
	...
	result := Gnome[float64]{}.Sort(unsortedArr)

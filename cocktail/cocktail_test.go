...
func TestCocktail_Sort_Int(t *testing.T) {
	unsortedArr := []int{3, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5}
	expectedArr := []int{1, 1, 2, 3, 3, 4, 5, 5, 5, 6, 9}

	result := Cocktail[int]{}.Sort(unsortedArr)
...
func TestCocktail_Sort_Uint32(t *testing.T) {
	...
	result := Cocktail[uint32]{}.Sort(unsortedArr)
...
func TestCocktail_Sort_Float64(t *testing.T) {
	...
	result := Cocktail[float64]{}.Sort(unsortedArr)

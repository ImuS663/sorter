...
func TestBubble_Sort_Uint32(t *testing.T) {
	...
	result := Bubble[uint32]{}.Sort(unsortedArr)
...
func TestBubble_Sort_Float64(t *testing.T) {
	...
	result := Bubble[float64]{}.Sort(unsortedArr)

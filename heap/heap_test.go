...
func TestHeap_Sort_Uint32(t *testing.T) {
	...
	result := Heap[uint32]{}.Sort(unsortedArr)
...
func TestHeap_Sort_Float64(t *testing.T) {
	...
	result := Heap[float64]{}.Sort(unsortedArr)

...
func TestQuick_Sort_Uint32(t *testing.T) {
	...
	result := Quick[uint32]{}.Sort(unsortedArr)
...
func TestQuick_Sort_Float64(t *testing.T) {
	...
	result := Quick[float64]{}.Sort(unsortedArr)

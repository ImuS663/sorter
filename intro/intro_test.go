...
func TestIntro_Sort_Uint32(t *testing.T) {
	...
	result := Intro[uint32]{}.Sort(unsortedArr)
...
func TestIntro_Sort_Float64(t *testing.T) {
	...
	result := Intro[float64]{}.Sort(unsortedArr)

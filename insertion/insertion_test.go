...
func TestInsertion_Sort_Int(t *testing.T) {
	unsortedArr := []int{3, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5}
	expectedArr := []int{1, 1, 2, 3, 3, 4, 5, 5, 5, 6, 9}

	result := Insertion[int]{}.Sort(unsortedArr)
...
func TestInsertion_Sort_Uint32(t *testing.T) {
	...
	result := Insertion[uint32]{}.Sort(unsortedArr)
...
func TestInsertion_Sort_Float64(t *testing.T) {
	...
	result := Insertion[float64]{}.Sort(unsortedArr)

...
func TestOddEven_Sort_Uint32(t *testing.T) {
	...
	result := OddEven[uint32]{}.Sort(unsortedArr)
...
func TestOddEven_Sort_Float64(t *testing.T) {
	...
	result := OddEven[float64]{}.Sort(unsortedArr)

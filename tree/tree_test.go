...
func TestTree_Sort_Uint32(t *testing.T) {
	...
	result := Tree[uint32]{}.Sort(unsortedArr)
...
func TestTree_Sort_Float64(t *testing.T) {
	...
	result := Tree[float64]{}.Sort(unsortedArr)
